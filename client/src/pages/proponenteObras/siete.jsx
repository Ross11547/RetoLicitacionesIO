...
const Siete = () => {
    const [form,setForm] = useState({
        ...
        itemUno: 0,
        itemUnoLiteral: "",
        itemUnoNumeralTotal: 0,
        itemDos: 0,
        itemDosLiteral: "",
        itemDosNumeralTotal: 0,
        itemTre: 0,
        itemTreLiteral: "",
        itemTreNumeralTotal: 0,
        itemCuatro: 0,
        itemCuatroLiteral: "",
        itemCuatroNumeralTotal: 0,
        itemCinco: 0,
        itemCincoLiteral: "",
        itemCincoNumeralTotal: 0,
        itemSeis: 0,
        itemSeisLiteral: "",
        itemSeisNumeralTotal: 0,
        itemSiete: 0,
        itemSieteLiteral: "",
        itemSieteNumeralTotal: 0,
        itemOcho: 0,
        itemOchoLiteral: "",
        itemOchoNumeralTotal: 0,
        itemNueve: 0,
        itemNueveLiteral: "",
        itemNueveNumeralTotal: 0,
        itemDiez: 0,
        itemDiezLiteral: "",
        itemDiezNumeralTotal: 0,
        item: 0,
        itemLiteral: "",
        itemNumeralTotal: 0,
        item: 0,
